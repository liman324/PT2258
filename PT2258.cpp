...
void PT2258::setVolume(int vol){
  ...
  int vol10 = vol/10;
  int vol1 = vol%10;
  writeWire(vol10+0b11010000, vol1+ 0b11100000);
}
...
void PT2258::setVol1(int v1){
  ...
  int v1_10 = v1/10;
  int v1_1 = v1%10;
  writeWire(v1_10+0b10000000, v1_1+ 0b10010000);
}
...
void PT2258::setVol2(int v2){
  ...
  int v2_10 = v2/10;
  int v2_1 = v2%10;
  writeWire(v2_10+0b01000000, v2_1+ 0b01010000);
}
...
void PT2258::setVol3(int v3){
  ...
  int v3_10 = v3/10;
  int v3_1 = v3%10;
  writeWire(v3_10+0b00000000, v3_1+ 0b00010000);
}
...
void PT2258::setVol4(int v4){
  ...
  int v4_10 = v4/10;
  int v4_1 = v4%10;
  writeWire(v4_10+0b00100000, v4_1+ 0b00110000);
}
...
void PT2258::setVol5(int v5){
  ...
  int v5_10 = v5/10;
  int v5_1 = v5%10;
  writeWire(v5_10+0b01100000, v5_1+ 0b01110000);
}
...
void PT2258::setVol6(int v6){
  ...
  int v6_10 = v6/10;
  int v6_1 = v6%10;
  writeWire(v6_10+0b10100000, v6_1+ 0b10110000);
}
